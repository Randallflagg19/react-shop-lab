...
export function CartRow({
  ...
  return (
    <article data-cart-row className="grid grid-cols-[minmax(0,1fr)_90px_150px_90px_80px] items-center gap-6 border-b border-[var(--border)] py-[18px] max-[640px]:grid-cols-[minmax(0,1fr)_auto] max-[640px]:gap-x-4 max-[640px]:gap-y-3">
      ...
      <div data-cart-quantity className="grid grid-cols-[40px_48px_40px] overflow-hidden rounded-md border border-[var(--border)] max-[640px]:col-start-1">
        <button
